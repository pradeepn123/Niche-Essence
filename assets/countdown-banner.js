      ...
      const updateTime = function () {
        ...
        if (_this.automaticSaleTimer) {
          ...
          const getConvertedTime = dateInstance => {
            ...
            const convertedTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(localTime).utcOffset(timeZoneOffset).format('YYYY-MM-DD HH:mm:ss');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors"], () => (__webpack_require__("./js/sections/countdown-banner.js")))
